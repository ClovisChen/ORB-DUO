...
public:
    ...
    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timeStamp, ORBextractor* extractorLeft, ORBextractor* extractorRight, ORBVocabulary* voc, cv::Mat &K,const float &bf, const float &thDepth);
...
//    std::vector<cv::KeyPoint> mvKeysUn;
    ...
    static long unsigned int nLastId; ///< Next Frame id.(Last Frame id)
